...
export const TOGGLE_EDIT_LINK_MENU: LexicalCommand<undefined> =
  createCommand();
  ...
  return (
    <>
      ...
      <div
        ...
        className={`absolute flex items-center justify-between bg-slate-100 border-[1px] edit-link-class-name ${
      ...
      >
        <input
          ...
          className="px-2 py-1 text-xs bg-transparent border-none outline-none edit-link-class-name"
