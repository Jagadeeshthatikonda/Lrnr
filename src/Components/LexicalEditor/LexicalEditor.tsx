...
const Placeholder = () => {
  return (
    <div className="absolute top-[1.125rem] left-[1.125rem] opacity-50">
      Start writing By Clicking Above Editor...
    </div>
  );
};
        ...
        children: [
          {
            ...
            mode: "normal",
            style: "",
            text: "Aute in qui amet labore adipisicing dolore. Cillum elit et labore ipsum minim laboris veniam. Incididunt aute do reprehenderit deserunt proident velit nisi esse adipisicing. Laboris sit in nulla deserunt id aliqua ullamco in. Aliquip anim amet dolore exercitation et amet velit reprehenderit id reprehenderit deserunt eiusmod.",
            type: "text",
            version: 1,
          },
        ],
